...
<head>
	...
	<title>Implementando Simplex</title>
</head>
<body>
...
//Declaração de Arrays
	...
	{	echo "<b><center>Você deve fazer a entrada dos dados corretamente, na página principal.php</center></b>"; die;	}
	...
	echo "<td><center>";
	echo "<h2><b><center>Informações Iniciais:</center></b></h2><hr>";
...
//Mostrando a tabela:
	echo "<hr>";
	echo "<h3><center><b>Montando a tabela Inicial:</center></b></h3>";
	...
	{
		$letrax; $letray;
		echo "<center><b><hr><i>Número desejado de iterações: <b><font color='red'>".($contador + 1)."</b></b></i></font></center>";
		...
		echo "<center><hr><i><b>Menor valor encontrado na tabela: <font color='red'>".$menorvalor."</b></i></font></center>";
		$menorvalbase = array();
...
//gerar menor valor na tabela
		...
		echo "<center><b>Valor é o: <font color='red'>".$menorvalentra."</b></font></center>";
		echo "<center><hr>Entra: <font color='red'>".$letray. "</font>; Sai: <font color='red'>". $letrax."</font>;</center>";
	...
	//Calculando pivô
		...
		echo "<center><b><hr>Valor do Pivô: <font color='red'>".$pivo."</b></font></center>";
		
		//Seleciona o pivô e divide a linha:
		for ($y=0; $y<count($colunatab); $y++)
		{	$tabela[$pivox][$y] = $tabela[$pivox][$y]/$pivo;		}

			echo "<h3><b><center>Calculando e mostrando tabela após dividir pelo pivô:</h3></b></center>";
			PrintaTabela($bstabela, $colunatab, $tabela);
	...
	function PrintaInicio($funcao, $sa, $valorarrfinal, $qtdeit)
	{
		...
		echo "<br/></center>";
		echo "<b>Quantidade de Iterações que foi escolhida: <font color='red'>".$qtdeit ."</font></b>";
